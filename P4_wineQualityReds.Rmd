...
```{r echo=FALSE}
ggplot(data = reds, 
                aes(x = citric.acid, y = volatile.acidity, color = quality.factor)) + 
  geom_jitter(alpha = 0.6, size = 2) + 
  scale_color_brewer(palette = "Greens") + 
  theme_dark()
```
...
plot1 <- ggplot(data = reds, aes(x = quality, y = alcohol)) + 
  geom_jitter(alpha = 0.4) + 
  geom_smooth(method=lm) + 
  ggtitle("Quality vs. Alcohol Scatterplot") + 
  labs(x = "Quality (score between 0 and 10)", y = "Alcohol (% by volume)")
plot2 <- ggplot(data = reds, aes(x = quality.factor, y = alcohol)) + 
  geom_boxplot() + 
  ggtitle("Quality vs. Alcohol box plot") + 
  labs(x = "Quality (score between 0 and 10)", y = "Alcohol (% by volume)")
...
plot1 <- ggplot(data = reds, aes(x = quality, y = volatile.acidity)) + 
  geom_jitter(alpha = 0.4) + 
  geom_smooth(method=lm) + 
  ggtitle("Quality vs. Volatile Acidity Scatterplot") + 
  labs(x = "Quality (score between 0 and 10)", y = "Volatile Acidity (acetic acid - g / dm^3)")
plot2 <- ggplot(data = reds, aes(x = quality.factor, y = volatile.acidity)) + 
  geom_boxplot() + 
...
plot1 <- ggplot(data = reds, aes(x = quality, y = citric.acid)) + 
  geom_jitter(alpha = 0.4) + 
  geom_smooth(method=lm) + 
  ggtitle("Quality vs. Citric Acidity Scatterplot") + 
  labs(x = "Quality (score between 0 and 10)", y = "Citric Acidity (acetic acid - g / dm^3)")
plot2 <- ggplot(data = reds, aes(x = quality.factor, y = citric.acid)) + 
  geom_boxplot() + 
